...
INSERT INTO `x-admin-template`.x_menu (id, name, path, component, title, redirect, parent_id, icon, order_num, created_at, updated_at, deleted) VALUES (5, 'dept', 'dept', 'sys/dept/index', '部门管理', '/sys/dept/post', 3, 'el-icon-eleme', 5, '2025-06-12 18:25:24', '2025-08-12 17:00:02', 0);
...
INSERT INTO `x-admin-template`.x_menu (id, name, path, component, title, redirect, parent_id, icon, order_num, created_at, updated_at, deleted) VALUES (12, 'post', 'post', 'sys/dept/post', '组织结构', '', 5, 'el-icon-share', 11, '2025-08-12 15:19:41', '2025-08-12 15:19:41', 0);
...
INSERT INTO `x-admin-template`.x_dept (id, parent_id, ancestors, dept_name, order_num, leader, phone, email, status, deleted, create_by, create_time, update_by, update_time) VALUES (100, 0, '0', '若依科技', 0, '若依', '15888888888', 'ry@qq.com', 0, 0, 'admin', '2025-02-11 14:08:38', '', null);
INSERT INTO `x-admin-template`.x_dept (id, parent_id, ancestors, dept_name, order_num, leader, phone, email, status, deleted, create_by, create_time, update_by, update_time) VALUES (101, 100, '0,100', '深圳总公司', 1, '若依', '15888888888', 'ry@qq.com', 0, 0, 'admin', '2025-02-11 14:08:38', '', null);
INSERT INTO `x-admin-template`.x_dept (id, parent_id, ancestors, dept_name, order_num, leader, phone, email, status, deleted, create_by, create_time, update_by, update_time) VALUES (102, 100, '0,100', '长沙分公司', 2, '若依', '15888888888', 'ry@qq.com', 0, 0, 'admin', '2025-02-11 14:08:38', '', null);
INSERT INTO `x-admin-template`.x_dept (id, parent_id, ancestors, dept_name, order_num, leader, phone, email, status, deleted, create_by, create_time, update_by, update_time) VALUES (103, 101, '0,100,101', '研发部门', 1, '若依', '15888888888', 'ry@qq.com', 0, 0, 'admin', '2025-02-11 14:08:38', '', null);
INSERT INTO `x-admin-template`.x_dept (id, parent_id, ancestors, dept_name, order_num, leader, phone, email, status, deleted, create_by, create_time, update_by, update_time) VALUES (104, 101, '0,100,101', '市场部门', 2, '若依', '15888888888', 'ry@qq.com', 0, 0, 'admin', '2025-02-11 14:08:38', '', null);
INSERT INTO `x-admin-template`.x_dept (id, parent_id, ancestors, dept_name, order_num, leader, phone, email, status, deleted, create_by, create_time, update_by, update_time) VALUES (105, 101, '0,100,101', '测试部门', 3, '若依', '15888888888', 'ry@qq.com', 0, 0, 'admin', '2025-02-11 14:08:38', '', null);
INSERT INTO `x-admin-template`.x_dept (id, parent_id, ancestors, dept_name, order_num, leader, phone, email, status, deleted, create_by, create_time, update_by, update_time) VALUES (106, 101, '0,100,101', '财务部门', 4, '若依', '15888888888', 'ry@qq.com', 0, 0, 'admin', '2025-02-11 14:08:38', '', null);
